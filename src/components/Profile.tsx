...
const socials = [
    {
        name: "Github",
        link: "https://github.com/salimkhan668580",
        icon: <FaGithub className="size-4" />
    },
    {
        name: "LinkedIn",
        link: "https://www.linkedin.com/in/salimkhan668580",
            ...
            <CardContent className="pt-6">
                <div className="flex flex-col items-start gap-2 ">
                    <div className="w-full flex flex-row justify-between items-top ">
                        ...
                        src="/salim image.jpg"
                        alt="Profile Picture"
                        className="rounded-full h-[100px] w-[100px] md:h-[250px]  md:w-[250px] object-cover border-2"
                        />
                            {/* <Image
                                width={100}
                                height={100}
                            ...
                            <div className="flex flex-col items-start justify-center">
                                <h1 className="font-bold md:mt-4 text-xl md:text-2xl">SALIM KHAN</h1>
